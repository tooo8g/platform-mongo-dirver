...
public class Good {
	...
	private String  contract_id;//订单合同编号
	private String  product_code;//产品标示代码
	private String  materials_name;//产品名称
	private String  specifications_model;//规格型号
	private String  materials_code;//物资编码
